...
class TEXT:
    ...
    UPLOAD_SUCESS = f"Thanks for using [ME](https://instagram/yukawa_beats)"
...
** Source Code:** [Press Me](https://github.com/Yukawa-Beats/TG-RENAMER-BOT)
"""
...
**For Donate:** message me @chekuthan_0405"""
